...
import { wall_schematic as FN } from './fn4.mjs';
...
// --- write svg docs ---
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/big4.svg', doc(a,400,864));
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/small_scaled4.svg', doc(a,400,864,100));
const sm = FN(0,0,100,216,P,mk(1234),'t2');
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/small_native4.svg', doc(sm,100,216));
// offset test: draw inside a sub-rect of a bigger canvas
const off = FN(60,80,280,600,P,mk(5),'t3');
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/offset4.svg',
