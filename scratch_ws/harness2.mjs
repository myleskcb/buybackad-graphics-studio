...
import { wall_schematic as FN } from './fn2.mjs';
...
// --- write svg docs ---
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/big2.svg', doc(a,400,864));
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/small_scaled2.svg', doc(a,400,864,100));
const sm = FN(0,0,100,216,P,mk(1234),'t2');
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/small_native2.svg', doc(sm,100,216));
// offset test: draw inside a sub-rect of a bigger canvas
const off = FN(60,80,280,600,P,mk(5),'t3');
writeFileSync('/Users/admin/Downloads/gfxv23/scratch_ws/offset2.svg',
