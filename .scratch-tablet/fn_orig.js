function frame_tablet(x, y, w, h, P, R, id) {
  ...
  var cxc = bx + dw / 2, cyc = by + bez * 0.5, cr = Math.max(0.7, bez * 0.28);
  body += '<circle cx="' + n(cxc) + '" cy="' + n(cyc) + '" r="' + n(cr) + '" fill="' + shade + '" opacity="0.9"/>'
    + '<circle cx="' + n(cxc) + '" cy="' + n(cyc) + '" r="' + n(cr) + '" fill="none" stroke="' + light + '" stroke-opacity="0.14" stroke-width="' + n(Math.max(0.4, cr * 0.28)) + '"/>'
